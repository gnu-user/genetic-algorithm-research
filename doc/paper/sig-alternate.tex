...
- I will write the formal algoritm in latex using the latex algorithm extension
...
- In the event where there are multiple types of collisions (say two pairs of queens each with 
  vertical collisions, and one with a horizontal collision) the fitness value would be (1 / 8), 
