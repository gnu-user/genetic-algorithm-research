...
Classic Genetic Algorithms been the subject for attempted improvement over the last few decades. Since Genetic Algorithms are inspired by real life attempts have been made to add more nature based augmentations to improve the performance of Genetic Algorithms. One major example of this is Adaptive Genetic Algorithms which generally, an attempt to adjust the genetic operations actively to escape local optimum faster and reach maximums quicker (aka perform better). 

%Talk about specific adaptive papers.
means changing one or more of the defined variables (such as mutation or crossover rate) actively based on the progress of the population's fitness function [Adaptive probabilities of crossover and mutation in genetic algorithms], [Genetic Algorithms and Directed Adaptation]
